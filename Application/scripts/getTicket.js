...
module.exports = function (callback) {
    ...
    web3.eth.getAccounts().then(function (account) {
        ...
        contract.deployed().then(function (instance) {
            billet = instance;
            var t = billet.getTicket(14, 0, { from: account[0] });
            ...
            var t2 = billet.getTicket(14, 43, { from: account[0] });
            ...
            var t_2 = billet.getTicket(17, 0, { from: account[0] });
            ...
            var t2_2 = billet.getTicket(17, 55, { from: account[0] });
            ...
            var a2 = billet.getTicketAvailable(17, { from: account[0] });
