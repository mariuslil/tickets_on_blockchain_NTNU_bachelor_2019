...
module.exports = function (callback) {
    ...
    web3.eth.getAccounts().then(function (account) {
        ...
        contract.deployed().then(function (instance) {
            ...
            var invaild13_1 = billet.invaildTicket(13, 14, { from: account[0] });
            ...
            var invaild13_2 = billet.invaildTicket(13, 17, { from: account[0] });
            ...
            var invaild26 = billet.invaildTicket(26, 17, { from: account[1] });
            ...
            var invaild2 = billet.invaildTicket(2, 14, { from: account[2] });
