...
module.exports = function (callback) {
    ...
    web3.eth.getAccounts().then(function (account) {
        ...
        contract.deployed().then(function (instance) {
            ...
            var invaild1 = billet.invaildTicket(13, 14, { from: account[2], to: account[2] });
            console.log("invaildTicket(13, 14)");
            ...
            var invaild2 = billet.invaildTicket(13, 17, { from: account[2], to: account[2] });
            console.log("invaildTicket(13, 17)");
            ...
            var invaild3 = billet.invaildTicket(26, 17, { from: account[3], to: account[3] });
            console.log("invaildTicket(26, 17)");
            ...
            var invaild3 = billet.invaildTicket(2, 14, { from: account[4], to: account[4] });
            console.log("invaildTicket(2, 14)");
