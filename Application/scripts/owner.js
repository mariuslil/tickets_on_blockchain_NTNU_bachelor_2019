...
module.exports = function (callback) {
    ...
    web3.eth.getAccounts().then(function (account) {
        ...
        contract.deployed().then(function (instance) {
            ...
            var o = billet.createOwner(13, "Andrine Celine Flatby", account[0], 7345232, { from: account[0] });
            ...
            var o2 = billet.createOwner(26, "Marius Lillevik", account[1], 45423455, { from: account[1] });
            ...
            var o3 = billet.createOwner(2, "Ole Bjørn Gran", account[2], 53524231, { from: account[2] });
