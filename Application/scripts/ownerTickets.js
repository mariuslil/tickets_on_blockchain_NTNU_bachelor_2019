...
module.exports = function (callback) {
    ...
    web3.eth.getAccounts().then(function (account) {
        ...
        contract.deployed().then(function (instance) {
            ...
            var o13t = billet.getOwner_ticket(13, 0, { from: account[0] });
            ...
            var o13t_10 = billet.getOwner_ticket(13, 10, { from: account[0] });
            ...
            var o13t_19 = billet.getOwner_ticket(13, 19, { from: account[0] });
            ...
            var o26t_4 = billet.getOwner_ticket(26, 4, { from: account[1] });
            ...
            var ot2_7 = billet.getOwner_ticket(2, 6, { from: account[2] });
            ...
            var numberTicket13_1 = get_number_Of_ticket_own(13, 14, { from: account[0] });
            ...
            var numberTicket13_2 = get_number_Of_ticket_own(13, 17, { from: account[0] });
            ...
            var numberTicket26 = get_number_Of_ticket_own(26, 17, { from: account[1] });
            ...
            var numberTicket2 = get_number_Of_ticket_own(2, 14, { from: account[2] });
