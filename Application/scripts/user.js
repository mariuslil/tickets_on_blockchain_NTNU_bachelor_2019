...
module.exports = function (callback) {
    ...
    web3.eth.getAccounts().then(function (account) {
        ...
        contract.deployed().then(function (instance) {
            ...
            var user1 = billet.createUser(13, "Andrine Celine Flatby", account[0], 7345232, { from: account[2], to: account[2] });
            ...
            var user2 = billet.createUser(26, "Marius Lillevik", account[1], 45423455, { from: account[3], to: account[3] });
            ...
            var user3 = billet.createUser(2, "Ole Bjørn Gran", account[2], 53524231, { from: account[4], to: account[4] });
